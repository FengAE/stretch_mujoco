...
This copy keeps the Menagerie geometry and planar simulation base, and adds
the public head kinematics, camera mount, IMU mounts, perimeter time-of-flight
mounts, and cliff-sensor mounts from SimplerEnv's
`google_robot_meta_sim_fix_fingertip.urdf`. The RGB intrinsics use
`GoogleRobotManualTunedIntrinsicConfig`. These are real-to-sim parameters, not
an official manufacturing calibration package.
